...
run: compile
	...
	# Imgfilt
	#python2 ./src/doping.py -- g++ -O2 test/imgfilt/imgfilt-cpp.cc -o qtest
	#time ./qtest 50
	#g++ -O2 test/imgfilt/imgfilt-cpp.cc -o qtest_original
	#time ./qtest_original 50

	# Skewedgaussseidel
	#python2 ./src/doping.py -- g++ -O2 test/skewedgaussseidel/skewedgaussseidel.cc -o qtest
	#time ./qtest 50
	#g++ -O2 test/skewedgaussseidel/skewedgaussseidel.cc -o qtest_original
	#time ./qtest_original 50
